...
const WhatsAppFloat = () => {
  ...
  const [step, setStep] = useState('welcome'); // welcome, form, direct
  ...
  const startChat = () => {
    ...
    // Send captured data via EmailJS first
    sendEmail({
      ...formData,
              ...
              <AnimatePresence mode="wait">
                {step === 'welcome' && (
                  ...
                  >
                    ...
                    <div className="widget-options">
                      <button onClick={() => setStep('form')} className="option-btn primary">
                        Start Chat (Share Details)
                      </button>
                      <button onClick={goDirect} className="option-btn secondary">
                        Go Direct to WhatsApp
                      </button>
                    </div>
                  </motion.div>
                )}
                ...
                {step === 'form' && (
                  ...
                  >
                    ...
                    <button onClick={() => setStep('welcome')} className="btn-secondary btn-small">
                      ← Back
                    </button>
                  </motion.div>
                )}
